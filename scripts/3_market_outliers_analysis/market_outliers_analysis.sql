/*
--------------------------------------------------------------------------------
NAME:            Football Market Analytics - Elite Player Identification
PURPOSE:         Identify "Market Outliers" (Top 5%) within specific groups.
DESCRIPTION:     This script builds a multi-layered analytical view to benchmark 
                 football player market values. It uses statistical percentiles 
                 (P5, Q1, Median, Q3, P95) to categorize players relative to 
                 their specific peer groups (League, Position, and Age Bucket).
--------------------------------------------------------------------------------
*/
...
-- =============================================================================
-- This view prepares a comprehensive dataset where every player's value 
-- is compared against the statistical distribution of their specific peer group.
