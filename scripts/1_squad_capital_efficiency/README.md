...
### **2.1. What are TOP 3 the best performing and the worst performing teams in Bundesliga?**
```sql
(SELECT
    league_name,
...
### **2.2. Are there any teams that have points average higher than the competition one and they are in TOP 3 'Capital Efficient'?**
```sql
SELECT
    league_name,
    'TOP 3 BEST PERFORMERS' AS type,
